 ...
 *
 * @module CityCreeksController
 * @kind class
 *
 * @extends Controller
 * @requires Controller
 *
 * @classdesc CityCreeksController class
 */


class CityCreeksController extends require("@ongojs/controller") {
  ...
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(CityCreeksController);
    // auto invoke methods
    this.autoinvoker(CityCreeksController);
...
module.exports = CityCreeksController;
