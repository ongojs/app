 ...
 * @requires Controller
 *
 * @classdesc PeoplesController class
 */


class PeoplesController extends require("@ongojs/controller") {
  ...
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(PeoplesController);
    // auto invoke methods
    this.autoinvoker(PeoplesController);
