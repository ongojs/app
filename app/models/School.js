...
|--------------------------------------------------------------------------------
|
| School extends the base model (Model) class and thus has everything
...
const Model = require('@ongojs/model');
 ...
 class School extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'schools', url: 'mongodb://localhost:27017', db: 'mvc'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'schools';
