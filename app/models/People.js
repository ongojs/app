...
|--------------------------------------------------------------------------------
|
| People extends the base model (Model) class and thus has everything
...
const Model = require('@ongojs/model');
 ...
 class People extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'peoples', url: 'mongodb://localhost:27017', db: 'mvc'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'peoples';
