...
|--------------------------------------------------------------------------------
|
| CityCreek extends the base model (Model) class and thus has everything
...
const Model = require('@ongojs/model');
 ...
 class CityCreek extends Model{
    ...
    |
    */
    constructor(dbOptions = {collection: 'citycreeks', url: 'mongodb://localhost:27017', db: 'mvc'},...options){
    ...
    */
    ...
    if(!this['hasOwnProperty']['collection']) this.collection = 'citycreeks';
